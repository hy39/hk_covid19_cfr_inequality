...
The following section will reproduce the combined graph of above three
bar diagram.
...
#Correlation plot between the decreased condition,gender,age, hospitalization time and report delay.
