...
##CFR over hospitalization time #Alive group distribution
...
#Correlation plot of CI, case fatality rate (CFR), median income, average age and average patient age#
...
#Correlation matrix of symptomatic patients using individual data#
...
#Correlation matrix of symptomatic diseased patients using individual data#
